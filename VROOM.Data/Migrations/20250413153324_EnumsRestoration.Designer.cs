...
namespace VROOM.Data.Migrations
{
    ...
    [Migration("20250413153324_EnumsRestoration")]
    partial class EnumsRestoration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VROOM.Models.Shipment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Beginning = new DateTime(2025, 4, 10, 8, 0, 0, 0, DateTimeKind.Unspecified),
                            End = new DateTime(2025, 4, 10, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            MaxConsecutiveDeliveries = 5,
                            ModifiedAt = new DateTime(2025, 4, 10, 8, 0, 0, 0, DateTimeKind.Unspecified),
                            ModifiedBy = "TestUser",
                            RiderID = 1,
                            Status = 0
                        },
                        ...
                        {
                            Id = 2,
                            Beginning = new DateTime(2025, 4, 11, 9, 0, 0, 0, DateTimeKind.Unspecified),
                            End = new DateTime(2025, 4, 11, 13, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            MaxConsecutiveDeliveries = 3,
                            ModifiedAt = new DateTime(2025, 4, 11, 9, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("VROOM.Models.Route", b =>
                {
                    b.HasOne("VROOM.Models.Shipment", "Shipment")
                        .WithOne("Route")
                        .HasForeignKey("VROOM.Models.Route", "ShipmentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VROOM.Models.Shipment", b =>
                {
                    ...
                    b.HasOne("VROOM.Models.Rider", null)
                        .WithMany("Shipments")
                        .HasForeignKey("RiderId");
